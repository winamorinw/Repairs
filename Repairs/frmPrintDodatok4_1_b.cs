...
namespace Repairs
{
    public partial class frmPrintDodatok4_1_b : Form
    {
        public frmPrintDodatok4_1_b(string ID, string ZakCx, string ZakUch, string ZakBrig, string ZakDet, string IspCx, string IspUch,
