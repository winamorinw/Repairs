...
namespace Repairs
{
    public partial class frmPrintDodatok2_1_a : Form
    {
        public frmPrintDodatok2_1_a(string ID,string  ZakCx,string  ZakUch,string  ZakBrig,string  ZakDet,string  IspCx,string  IspUch,
